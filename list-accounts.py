  ...
  """
    ...
    for myDomain in myDomainsList:
        ...
        for myAccount in c.getAccountsList(myDomain):
            ...
            wlli = ""
            # WebMail Last Login IP
            alld = ""
            # Active Sync Last Login Date
            alli = ""
            # Active Sync Last Login IP
            olld = ""
            # Outlook Connector Last Login Date
            olli = ""
            # Outlook Connector Last Login IP
            lld = ""
            # Last Login Date
            imc = ""
            # Internal Mbox Container ID
            cv = ""
            # Configuration Version
            msv = ""
            # Mbox Storage Version
            ali = ""
            # Associated LDAP ID
            ald = ""
            # Associated LDAP DN
            ...
            if listRegistry or listAll:
                ...
                if listplld or listAll:
                    plld = (
                        "\n\tPOP3 Last Login Date: %s"
                        % myRegistry["POP3 Last Login Date"]
                    )
                ...
                if listilld or listAll:
                    illd = (
                        "\n\tIMAP Last Login Date: %s"
                        % myRegistry["IMAP Last Login Date"]
                    )
                ...
                if listwlld or listAll:
                    wlld = (
                        "\n\tWebMail Last Login Date: %s"
                        % myRegistry["WebMail Last Login Date"]
                    )
                if listwlli or listAll:
                    wlli = (
                        "\n\tWebMail Last Login IP: %s"
                        % myRegistry["WebMail Last Login IP"]
                    )

                if listalld or listAll:
                    alld = (
                        "\n\tActive Sync Last Login Date: %s"
                        % myRegistry["Active Sync Last Login Date"]
                    )
                if listalli or listAll:
                    alli = (
                        "\n\tActive Sync Last Login IP: %s"
                        % myRegistry["Active Sync Last Login IP"]
                    )
                if listolld or listAll:
                    olld = (
                        "\n\tOutlook Connector Last Login Date: %s"
                        % myRegistry["OLK Last Login Date"]
                    )
                if listolli or listAll:
                    olli = (
                        "\n\tOutlook Connector Last Login IP: %s"
                        % myRegistry["OLK Last Login IP"]
                    )
                ...
                if listimc or listAll:
                    imc = (
                        "\n\tInternal Mbox Container ID: %s"
                        % myRegistry["Internal Mbox Container ID"]
                    )
                if listcv or listAll:
                    cv = (
                        "\n\tConfiguration Version: %s"
                        % myRegistry["Configuration Version"]
                    )
                if listmsv or listAll:
                    msv = (
                        "\n\tMbox Storage Version: %s"
                        % myRegistry["Mbox Storage Version"]
                    )
                ...
                if listcs or listAll:
                    cs = (
                        ...
                        % myRegistry["Configuration Status"]
                    )
                ...
                if listmss or listAll:
                    mss = (
                        "\n\tMbox Storage Status: %s"
                        % myRegistry["Mbox Storage Status"]
                    )
